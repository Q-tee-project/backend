"""add_student_id_to_grading_sessions

Revision ID: bf7d6f8c7ff3
Revises: 690ffccd2ff9
Create Date: 2025-09-23 11:46:46.684213
...
revision = 'bf7d6f8c7ff3'
down_revision = '690ffccd2ff9'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('korean_grading_sessions_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('worksheet_id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('korean_teachers_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('username', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('email', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('phone', sa.VARCHAR(), autoincrement=False, nullable=False),
